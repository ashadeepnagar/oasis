// --- MANAGE YOUR ITEMS HERE ---
    const menuData = {
      drinks: { title: "Shakes", accent: "amber", items: [
      ...
      pizza: { title: "Pizzas", accent: "red", items: [
      ...
      burgers: { title: "Burgers", accent: "orange", items: [
        { name: "Veggie Supreme", price: 180, img: "/assets/images/burgers/burger.jpg" }
      ]},
      tea: { title: "Tea`s", accent: "blue", items: [
        { name: "Hot Tea", price: 90, img: "/assets/images/tea.jpg" }
      ]},
